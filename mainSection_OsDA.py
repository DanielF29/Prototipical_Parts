...
from preprocess_Sec import mean, std, preprocess_input_function
...
if __name__ == '__main__':
    ...
    # python3 mainSection.py -gpuid=$1 -base_architecture=resnet50 -pps_per_class=10 -num_classes=6 -experiment_run=001
    ...
    from settingsSection import img_size, prototype_activation_function, add_on_layers_type 
    ...
    shutil.copy(src=os.path.join(os.getcwd(), 'settingsSection.py'), dst=model_dir)
    ...
    # load the data
    from settingsSection import train_dir, test_dir, train_push_dir, \
    ...
    # define optimizer
    from settingsSection import joint_optimizer_lrs, joint_lr_step_size
    ...
    from settingsSection import warm_optimizer_lrs
    ...
    from settingsSection import last_layer_optimizer_lr
    last_layer_optimizer_specs = [{'params': ppnet.last_layer.parameters(), 'lr': last_layer_optimizer_lr}]
    last_layer_optimizer = torch.optim.Adam(last_layer_optimizer_specs)

    # weighting of different training losses
    from settingsSection import coefs

    # number of training epochs, number of warm epochs, push start epoch, push epochs
    from settingsSection import num_train_epochs, num_warm_epochs, push_start, push_epochs
