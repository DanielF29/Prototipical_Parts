...
from preprocess_Sur import mean, std, preprocess_input_function
...
if __name__ == '__main__':
    ...
    from settingsSurface import img_size, prototype_activation_function, add_on_layers_type 
    ...
    shutil.copy(src=os.path.join(os.getcwd(), 'settingsSurface.py'), dst=model_dir)
    ...
    # load the data
    from settingsSurface import train_dir, test_dir, train_push_dir, \
    ...
    # define optimizer
    from settingsSurface import joint_optimizer_lrs, joint_lr_step_size
    ...
    from settingsSurface import warm_optimizer_lrs
    ...
    from settingsSurface import last_layer_optimizer_lr
    last_layer_optimizer_specs = [{'params': ppnet.last_layer.parameters(), 'lr': last_layer_optimizer_lr}]
    last_layer_optimizer = torch.optim.Adam(last_layer_optimizer_specs)

    # weighting of different training losses
    from settingsSurface import coefs

    # number of training epochs, number of warm epochs, push start epoch, push epochs
    from settingsSurface import num_train_epochs, num_warm_epochs, push_start, push_epochs
