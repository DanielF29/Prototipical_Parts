...
save_analysis_path = os.path.join('pps_explanations', model_base_architecture, experiment_run, load_model_name)
...
load_img_dir = os.path.join(load_model_dir, 'img') ### path to prototypical parts images folder
### next line: load the part-prototype as a numpy vector
...
#"""
k = 6 #50 #number of top K classes to save their part-prototypes 
...
for i,c in enumerate(topk_classes.detach().cpu().numpy()):
    ...
    log('***************************************************************')
#""" 
#log('***************************************************************') ### added comment to the log file
